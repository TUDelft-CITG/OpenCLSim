...
def test_processor(
    ...
    np.testing.assert_almost_equal(processor.log["Value"][-3], (env.now - start) * 4)
...
def test_Processor_ContainerDependentMovable(
    ...
    np.testing.assert_almost_equal(processor_1.log["Value"][-3], (env.now - start) * 4)
    ...
    np.testing.assert_almost_equal(processor_2.log["Value"][-3], (env.now - start) * 3)
