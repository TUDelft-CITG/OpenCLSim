...
def test_delay_plugin():
    ...
    while_benchmark = {
        ...
        "ObjectState": [
            ...
            {},
            {},
            {"message": "delay and downtime Sequence activity Single run process"},
            {"message": "delay and downtime Sequence activity Single run process"},
            {},
            {},
            {},
            ...
            {},
            {},
            {"message": "delay and downtime While activity while"},
            {"message": "delay and downtime While activity while"},
            {},
        ],
    }
    ...
    assert while_activity.log == while_benchmark
