...
@pytest.fixture
def LocationWeather():
    return type('Location with Metocean', 
               (core.Identifiable,            # Give it a name
                core.Log,                     # Allow logging of all discrete events
                core.Locatable,               # Add coordinates to extract distance information and visualize
                core.HasContainer,            # Add information on the material available at the site
                core.HasResource,             # Add information on serving equipment
                core.HasWeather),             # Add information on metocean data
               {})

# make a location without metocean data
@pytest.fixture
def Location():
    return type('Location without Metocean', 
               (core.Identifiable,            # Give it a name
                core.Log,                     # Allow logging of all discrete events
                core.Locatable,               # Add coordinates to extract distance information and visualize
                core.HasContainer,            # Add information on the material available at the site
...
def test_calc_restrictions(env, geometry_a, Mover, Processor, LocationWeather, weather_data):
    ...
    data = {"env": env,                                       # The simpy environment 
            ...
            "filling": None}                                  # The filling degree
    ...
    data = {"env": env,                       # The simpy environment defined in the first cel
