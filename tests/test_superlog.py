...
def test_dependencies():
    ...
    for some_tuple in [('cp_activity_1', 'cp_activity_2'), ('cp_activity_106', 'cp_activity_2'),
                       ('cp_activity_2', 'cp_activity_44'), ('cp_activity_45', 'cp_activity_24'),
                       ('cp_activity_24', 'cp_activity_34')]:
        assert some_tuple in my_log.dependencies, f"specific dependency missing {some_tuple}"
...
def test_from_objects():
    ...
    assert len(my_log.dependencies) == 113, "113 dependencies expected"
    for some_tuple in [('cp_activity_3', 'cp_activity_45'), ('cp_activity_13', 'cp_activity_55'),
