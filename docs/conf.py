...
# -*- coding: utf-8 -*-
#
# digital_twin documentation build configuration file, created by
...
release = digital_twin.__version__
...
htmlhelp_basename = 'digital_twindoc'
