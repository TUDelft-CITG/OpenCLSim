...
# -*- coding: utf-8 -*-
#
# openclsim documentation build configuration file, created by
...
version = getattr(openclsim, "__version__", "").strip("v")
# The full version, including alpha/beta/rc tags.
release = getattr(openclsim, "__version__", "").strip("v")
...
htmlhelp_basename = "openclsimdoc"
